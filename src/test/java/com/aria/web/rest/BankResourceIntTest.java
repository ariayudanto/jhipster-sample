...
import com.aria.JhipsterApp;

import com.aria.domain.Bank;
import com.aria.repository.BankRepository;
import com.aria.web.rest.errors.ExceptionTranslator;
...
import static com.aria.web.rest.TestUtil.createFormattingConversionService;
...
public class BankResourceIntTest {
    ...
    public void createBank() throws Exception {
        ...
        assertThat(testBank.getAccountHolder()).isEqualTo(DEFAULT_ACCOUNT_HOLDER);
    }
    ...
    public void getAllBanks() throws Exception {
        ...
        restBankMockMvc.perform(get("/api/banks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].accountHolder").value(hasItem(DEFAULT_ACCOUNT_HOLDER.toString())));
    }
    ...
    public void getBank() throws Exception {
        ...
        restBankMockMvc.perform(get("/api/banks/{id}", bank.getId()))
            ...
            .andExpect(jsonPath("$.accountHolder").value(DEFAULT_ACCOUNT_HOLDER.toString()));
    }
    ...
    public void updateBank() throws Exception {
        ...
        assertThat(testBank.getAccountHolder()).isEqualTo(UPDATED_ACCOUNT_HOLDER);
    }
